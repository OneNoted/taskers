...
pub const Surface = extern struct {
    ...
    const Private = struct {
        /// The host application context for embedded consumers.
        host_app: ?*Application = null,
    ...
    pub fn new(overrides: NewOverrides) *Self {
        return newForApp(Application.default(), overrides);
    }
    ...
    pub fn hostApp(self: *Self) *Application {
        return self.private().host_app orelse Application.default();
    }
    ...
    pub fn keySequenceAction(
        ...
        const priv = self.private();
        const alloc = self.hostApp().allocator();
    ...
    fn finalize(self: *Self) callconv(.c) void {
        ...
        if (priv.core_surface) |v| {
            ...
            self.hostApp().core().deleteSurface(self.rt());
    ...
    fn glareaResize(
        ...
        const changed =
            priv.size.width != new_size.width or priv.size.height != new_size.height;
        priv.size = new_size;
...
const Clipboard = struct {
    ...
    fn clipboardReadText(
        ...
        const alloc = req.self.hostApp().allocator();
